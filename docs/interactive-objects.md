...
- drag over the left panel to rotate only the orbital;
- use the world-fixed black x/y/z triad to read the scene orientation; its
  endpoint labels remain billboarded toward the viewer;
...
three-slide presentation demonstrates `2s`, `2pz`, and `3dz2`:
