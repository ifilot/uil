...
const std::array<QVector<AngularName>, 5>& angular_names() {
    static const std::array<QVector<AngularName>, 5> names{{
        ...
        {{"dxy", "d_xy", -2}, {"dxz", "d_xz", 1}, {"dyz", "d_yz", -1},
         {"dx2-y2", "d_(x2-y2)", 2}, {"dz2", "d_z2", 0}},
        {{"fy(3x2-y2)", "f_y(3x2-y2)", -3}, {"fxyz", "f_xyz", -2},
         {"fy(5z2-r2)", "f_y(5z2-r2)", -1},
         {"fz(5z2-3r2)", "f_z(5z2-3r2)", 0},
         {"fx(5z2-r2)", "f_x(5z2-r2)", 1},
         {"fz(x2-y2)", "f_z(x2-y2)", 2},
         {"fx(x2-3y2)", "f_x(x2-3y2)", 3}},
        {{"gxy(x2-y2)", "g_xy(x2-y2)", -4},
         {"gyz(3x2-y2)", "g_yz(3x2-y2)", -3},
         {"gxy(7z2-r2)", "g_xy(7z2-r2)", -2},
         {"gyz(7z2-3r2)", "g_yz(7z2-3r2)", -1},
         {"g(35z4-30z2r2+3r4)", "g_(35z4-30z2r2+3r4)", 0},
         {"gxz(7z2-3r2)", "g_xz(7z2-3r2)", 1},
         {"g(x2-y2)(7z2-r2)", "g_(x2-y2)(7z2-r2)", 2},
         {"gxz(x2-3y2)", "g_xz(x2-3y2)", 3},
         {"g(x4-6x2y2+y4)", "g_(x4-6x2y2+y4)", 4}},
    }};
    return names;
}
